...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='path\best.pt', help='trained weights path') # select your model.pt path
    ...
    parser.add_argument('--testtime', default=500, type=int, help='test time')
